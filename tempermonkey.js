...
try {
  ...
  //
  // 當前以下版本可供切換：'latest' | 'beta' | 'nightly' | 'dev' | '0.28' | '0.27' | '0.26' | '0.25' | '0.24' | '0.23', etc
  // target version available value are: 'latest' | 'beta' | 'nightly' | 'dev' | '0.28' | '0.27' | '0.26' | '0.25' | '0.24' | '0.23', etc
...
function getBundleUrl(
  /**
    @type{ | 'latest' | 'beta' | 'nightly' | 'dev' | '0.28' | '0.27' | '0.26' | '0.25' | '0.24' | '0.23' | '0.23' }
    */
  targetVersion,
) {
  /**
  ...
  */
  const builds = {
    ...
    '0.28': { hash: '0.28.0-20200823-beta2', filename: 'etoro' },
